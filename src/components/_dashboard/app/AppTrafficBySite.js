...
const SOCIALS = [
  {
    name: "M-Shwari",
    icon: "https://pbs.twimg.com/profile_images/1433791088377188384/iF03Ax_V_400x400.jpg",
  },
  {
    icon:
  ...
  {
    name: "Hustler Fund",
    icon: "https://netstorage-tuko.akamaized.net/images/29ff330fcdb8ed7d.jpg",
  },
  ...
  {
    name: "DSTV",
    icon: "https://upload.wikimedia.org/wikipedia/commons/2/23/DStv_Logo_2012.png",
  },
  {
    name: "PAWA",
